...
python ../../cli/pd_cli.py -p simple_router -i p4_pd_rpc.simple_router -s $PWD/tests/pd_thrift:$PWD/../../testutils -m "add_entry send_frame 2 set_addr_count 2 00:aa:bb:00:00:01 0xffffffff" -c localhost:22222
